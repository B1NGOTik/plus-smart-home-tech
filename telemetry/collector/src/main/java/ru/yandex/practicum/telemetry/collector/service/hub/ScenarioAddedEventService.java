...
@Service
public class ScenarioAddedEventService extends BaseHubService<ScenarioAddedEventAvro> {
    public ScenarioAddedEventService(ProducerClient producer) {
        super(producer);
    }
    ...
    private ScenarioConditionAvro mapToConditionAvro(ScenarioConditionProto scenarioCondition) {
        Object value = switch (scenarioCondition.getValueCase()) {
            ...
            case VALUE_NOT_SET -> throw new IllegalArgumentException("Условие не задано");
        };
